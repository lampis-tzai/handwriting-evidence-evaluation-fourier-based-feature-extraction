...
# different writers
writer_data_1 <- IAM_data[IAM_data$writer_id == "94", ]

writer_data_2 <- IAM_data[IAM_data$writer_id == "125", ]

background_data <- IAM_data[!(IAM_data$writer_id %in% c("94", "125")), ]
